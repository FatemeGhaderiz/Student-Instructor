...
urlpatterns = [
    ...
    path(
        "add-announcement/<slug:slug>",
        AddAnnouncementApi.as_view(),
        name="add-announcement",
    ),
    path("enrollment", EnrollmentApi.as_view(), name="enrollment"),
    path(
        "enrollment-private/<slug:slug>",
        PrivateEnrollmentApi.as_view(),
        name="enrollment-private",
    ),
    ...
    path(
        "exercise-submission/<slug:slug>",
        ExerciseSubmissionApi.as_view(),
        name="exercise-submission",
    ),
    path("course-instructor", CourseInstructorApi.as_view(), name="course-instructor"),
    path(
        "course-update-delete/<slug:slug>",
        UpdateAndDeleteCourseApi.as_view(),
