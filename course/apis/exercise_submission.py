...
class ExerciseSubmissionApi(APIView):
    ...
    def post(self, request , slug):
        serializer = self.InputExerciseSubmissionSerializer(data=request.data , context = {'request':request , 'slug' : slug})
        ...
        return Response(self.OutPutExerciseSubmissionSerializer(query, context={"request":request}).data)
